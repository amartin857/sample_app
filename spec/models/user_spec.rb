...
describe User do
  before { @user = User.new(name: "testing mctesty", email: "test@test.com", password: "foobar", password_confirmation: "foobar") }
  ...
  describe "when password confirmation is not set" do
  ...
  describe "micropost association" do
    ...
    describe "status" do
      ...
      before do
        ...
        3.times { followed_user.microposts.create!(content: "figgity diggity") }
      end
